...
typeof b&&"[object Function]"===e.call(b)});d.isFunction=m;var q=Array.isArray||function(b){return b&&"object"===typeof b?"[object Array]"===e.call(b):!1};d.isArray=q;d.escapeExpression=function(b){if(b instanceof f)return b.toString();if(!b&&0!==b)return"";b=""+b;return!k.test(b)?b:b.replace(g,l)};d.isEmpty=function(b){return!b&&0!==b?!0:q(b)&&0===b.length?!0:!1};return d}(u),s=function(){function f(d,f){var g;f&&f.firstLine&&(g=f.firstLine,d+=" - "+g+":"+f.firstColumn);for(var k=Error.prototype.constructor.call(this,
